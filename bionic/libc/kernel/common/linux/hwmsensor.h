...
#define SENSOR_TYPE_CAPSENSE            14
...
/* midify for Cypress Cap sense CY8C20236A support -- by liaoxl.lenovo 12.31.2011 */
#define ID_CAP                          (ID_BASE+SENSOR_TYPE_CAPSENSE-1)
...
#define SENSOR_CAP_SENSE     			(1 << ID_CAP) /* midify for Cypress Cap sense CY8C20236A support -- by liaoxl.lenovo 12.31.2011 */
...
#define EVENT_SENSOR_CAP_SENSE          SENSOR_CAP_SENSE /* midify for Cypress Cap sense CY8C20236A support -- by liaoxl.lenovo 12.31.2011 */
/*-----------------------------------------------------------------------------*/
...
typedef struct {
	...
	int 	sensor;
	/* sensor values */
	int	values[4]; /* midify for Cypress Cap sense CY8C20236A support -- by liaoxl.lenovo 12.31.2011 */
